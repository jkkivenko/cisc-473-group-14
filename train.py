...
def train_painter_multi(model, train_loader, val_loader, num_epochs, optimizer, loss_fn, perceptual_loss,
    ...
    for epoch in range(num_epochs):
        ...
        plt.pause(0.5)
    with open(f"models/{num_epochs}_{num_strokes}.pt", "wb") as f:
        torch.save(model, f)
...
if __name__ == "__main__":
    if len(sys.argv) > 2:
        ...
        print("USAGE: python3 train.py NUM_EPOCHS NUM_STROKES")